// components/technicien/TechnicienCompleted.js
...
const TechnicienCompleted = () => {
    ...
    return (
        <Box sx={{ p: 3 }}>
            <Typography variant="h4" sx={{ mb: 3 }}>✅ Mes visites terminées</Typography>
            {visits.length === 0 ? (
                <Paper sx={{ p: 3, textAlign: 'center' }}>
                    <Typography color="textSecondary">Aucune visite terminée</Typography>
                </Paper>
            ) : (
                        ...
                        <TableBody>
                            {visits.map((v) => (
                                <TableRow key={v.id}>
                                    ...
                                    <TableCell>
                                        <Chip label={v.statut} size="small" color="success" />
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
...
export default TechnicienCompleted;